 ...
 */
{
  ...
  "def": {
	...
	"xf_hpbar_part1": { "x": 0, "y": 19, "valign": "center", "w": 100, "h": 4, "bgColor": "0x000000", "alpha": "{{alive?50|0}}" },
	"xf_hpbar_part2_ally": { "x": 1, "y": 20, "valign": "center", "w": "{{hp-ratio:98}}", "h": 2, "bgColor": "0x11FF00", "alpha": "{{alive?75|0}}" }, // 0x11FF00
	"xf_hpbar_part2_enemy": { "x": 1, "y": 20, "valign": "center", "w": "{{hp-ratio:98}}", "h": 2, "bgColor": "0xFF1100", "alpha": "{{alive?75|0}}" },  // 0xFF1100 oder {{c:hp-ratio}}
	"hpInfo":
	  {
		  "enabled": true,
		  "x": 120,
